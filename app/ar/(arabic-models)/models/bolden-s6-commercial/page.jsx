  ...
  return (
      <>
        ...
        <WarrantyDisclaimerSection
                                  ...
                                  description="تحظى سيارات البيك أب التجارية سينوتراك بولدن ببرنامج ملكية متكامل مصمم لدعم الأداء طويل الأمد وتعزيز الاعتمادية التشغيلية في سوق المركبات التجارية في الإمارات. تأتي المركبة بضمان لمدة 10 سنوات (5 سنوات من الشركة المصنعة و5 سنوات من شركة رويال سويس لتجارة السيارات)، إضافة إلى باقة صيانة شاملة لمدة 5 سنوات أو 100,000 كيلومتر (أيهما يأتي أولًا)، ما يوفر قيمة تنافسية قوية لرواد الأعمال، وأصحاب الشركات، ومديري أساطيل البيك أب التجارية الباحثين عن الكفاءة وتقليل تكاليف التشغيل."
