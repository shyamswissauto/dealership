        ...
        <div className={styles.top}>
          ...
          <div className={styles.col}>
            ...
            <ul className={styles.contactList}>
              <li><a href="https://maps.app.goo.gl/ChJz6fV7KXVwUxR27" target="blank">C 178 Al Mahdar St, Industrial Area,<br />
ICAD V - Abu Dhabi, UAE</a></li>
        ...
        <div className={styles.socialRow}>
          ...
          <ul className={styles.socials} aria-label="Social media">
            <li>
              <Link href="https://www.facebook.com/people/Sinotruk-UAE/61579914192315/" aria-label="Facebook" className={styles.socialLink} target="_blank" rel="noopener noreferrer">
            ...
            <li>
              <Link href="https://x.com/SinotrukUAE" aria-label="X" className={styles.socialLink} target="_blank" rel="noopener noreferrer">
                <svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true">
            ...
            <li>
              <Link href="https://www.instagram.com/sinotrukbolden_uae/" aria-label="Instagram" className={styles.socialLink} target="_blank" rel="noopener noreferrer">
                <svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true">
            ...
            <li>
              <Link href="https://www.youtube.com/@Sinotrukuae" aria-label="YouTube" className={styles.socialLink} target="_blank" rel="noopener noreferrer">
                <svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true">
            ...
            <li>
              <Link href="https://www.linkedin.com/company/109429488" aria-label="LinkedIn" className={styles.socialLink} target="_blank" rel="noopener noreferrer">
                <svg viewBox="0 0 24 24" width="22" height="22" aria-hidden="true">
