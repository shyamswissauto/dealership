...
const LINKS = [
  ...
  { id: "exterior",       label: "الخارج" },
  { id: "interior",       label: "داخلي" },
  { id: "specifications", label: "مواصفات" },
];
...
export default function ProductSectionNav({
  ...
  return (
    <>
      <div className={`${styles.wrap} dirRtl`} role="navigation" aria-label="Section navigation">
...
function TestDriveModal({ onClose, modalImage, carOptions }) {
  ...
  return (
    <div className={`${styles.modalOverlay} dirRtl`} onClick={onClose} role="dialog" aria-modal="true">
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.modalRight}>
          ...
          <form className={styles.form} onSubmit={submit}>
            <input className={styles.input} placeholder="اسمك" required />
            <input type="email" className={styles.input} placeholder="البريد الإلكتروني" required />
            <input
              type="tel"
            ...
            <button type="submit" className={styles.cta}>احجز الآن</button>
          </form>
        </div>
