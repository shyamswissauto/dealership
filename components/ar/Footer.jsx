        ...
        <div className={styles.top}>
          ...
          <div className={styles.brand}>
            ...
            <p className={styles.blurb}>
              رويال سويس أوتو تريدينغ هي الوكيل والموزع المعتمد لشركة سينوتراك بولدن في ابوظبي - الإمارات العربية المتحدة. تم تصميم مركباتنا الصالحة لجميع التضاريس لتقديم أداء عالٍ. استمتع بثقة في كل رحلة، مدعومة بدعم الخبراء.
            </p>
          </div>
