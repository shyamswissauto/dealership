...
/* =========================================================
   ...
   value sent to API remains English.
========================================================= */
  ...
  const submit =
    async (e) => {
      ...
      try {
        ...
        console.warn(
          "Arabic Test Drive Popup submission failed:",
          err
        );
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <label
                htmlFor="test-drive-ar-website"
              >
                Website
              </label>

              <input
                id="test-drive-ar-website"
                name="website"
                type="text"
                tabIndex={-1}
                autoComplete="off"
