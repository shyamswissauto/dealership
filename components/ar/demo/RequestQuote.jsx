...
const MODELS = [
  ...
  { id: "bolden-off-road",     name: "بولدن أوف رود", body: "PICKUP", category: "PICKUP", img: "/assets/models/img2.webp" },
  { id: "bolden-passenger", name: "بولدن باسنجر", body: "PICKUP", category: "PICKUP", img: "/assets/models/img3.webp" },
  { id: "bolden-commercial",  name: "بولدن كوميرشال", body: "PICKUP", category: "PICKUP", img: "/assets/models/img1.webp" },
];

const TITLES = ["السيد", "الأستاذة", "السيدة"];
const LOCATIONS = ["دبي", "أبوظبي", "العين", "الشارقة", "Ajman", "رأس الخيمة", "Umm Al Quwain", "Fujairah"];
  ...
  return (
    <section className={styles.wrap} aria-labelledby="rq-title">
      ...
      <div className={styles.row}>
        ...
        <div className={styles.content}>
          <h3 className={styles.subtitle}>اختر الطراز</h3>
          ...
          {/* STEP 3 — FORM */}
          <form className={`${styles.form} dirRtl`} onSubmit={onSubmit} noValidate>
            <input type="hidden" name="modelId" value={selectedId} />

            {/* Title */}
            <div className={styles.field}>
              <label className={styles.label} htmlFor="rq-title-select">اللقب*</label>
              <div className={styles.selectWrap}>
                <select id="rq-title-select" name="title" className={`${styles.input} ${styles.select}`} required defaultValue="">
                  <option value="" disabled hidden>اختر اللقب</option>
            ...
            <div className={styles.grid2}>
              <div className={styles.field}>
                <label className={styles.label} htmlFor="firstName">اسم*</label>
                <input id="firstName" name="firstName" className={styles.input} required />
              </div>
              <div className={styles.field}>
                <label className={styles.label} htmlFor="lastName">العائلة*</label>
            ...
            <div className={styles.grid2}>
              <div className={styles.field}>
                  <label className={styles.label} htmlFor="phone">الهاتف *</label>
                  <input
                    id="phone"
                    name="phone"
            ...
            {/* Location */}
            <div className={styles.field}>
              <label className={styles.label} htmlFor="location">حدد الموقع *</label>
              <div className={styles.selectWrap}>
                <select id="location" name="location" className={`${styles.input} ${styles.select}`} defaultValue="" required>
                  <option value="" disabled hidden>حدد الموقع</option>
            ...
            {/* Comments */}
            <div className={styles.field}>
              <label className={styles.label} htmlFor="comments">تعليقات</label>
            ...
            <label className={styles.terms}>
              ...
              <span>لقد قرأت الشروط والأحكام وأوافق عليها</span>
            </label>
