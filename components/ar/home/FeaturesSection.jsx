    ...
    <section ref={rootRef} className={`${styles.wrap} dirRtl`} aria-labelledby="features-title">
      <div className={styles.container}>
        ...
        <div className={styles.grid}>
          ...
          >
            <Link
              href="/ar/models/bolden-s9-off-road?utm_source=website&utm_medium=hmpagelink&utm_campaign=featuremodels9"
          ...
          >
            <Link
              href="/ar/models?utm_source=website&utm_medium=hmpagelink&utm_campaign=featuremodels1"
          ...
          >
            <Link
              href="/ar/models?utm_source=website&utm_medium=hmpagelink&utm_campaign=featuremodels2"
              className={styles.card}
              style={{
