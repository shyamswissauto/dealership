          ...
          >
            ...
            <div className={styles.inner}>
              ...
              <span className={`${styles.desc} ${styles.fromBottom} dirRtl`}>
                بدأت شركة رويال سويس أوتو تريدينغ بهدف واحد: إعادة تعريف التنقل في الإمارات العربية المتحدة. وبفضل مركبات بولدن من سينوتروك، حققنا هذا الهدف. إن رحلتنا مبنية على الثقة والأداء والشغف بالتقدم.
              </span>
            </div>
          </Link>
