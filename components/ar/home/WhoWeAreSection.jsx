      ...
      <div className={styles.container}>
        <div className={styles.titlebox}>
            ...
            <p className={styles.kicker}>
              نحن شركة رويال سويس أوتو تريدينغ، الموزع المعتمد لشركة سينوتراك في ابوظبي - الإمارات العربية المتحدة. نحن نقدم مركبات مصممة لتوفير القوة والراحة والموثوقية. نحن وجهتك المثالية للحصول على مركبات عالمية المستوى ودعم ما بعد البيع الاحترافي.
            </p>
