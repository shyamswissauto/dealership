...
export default function HeroSlider({
  ...
  slides = [
    ...
    {
      desktop: "/assets/hero/uae/bolden-landing-ar.webp", //desktop: "/assets/hero/bolden-landing.webp",
      mobile:  "/assets/hero/uae/bolden-landing-ar-m.webp", //mobile:  "/assets/hero/bolden-home-page-banner-m.webp",
      title:   "",
      subtitle:"",
      align:   "left",
      overlay: "rgba(0,0,0,.12)",
      learnMoreHref: "/ar/models/",
      bookHref:      "/",
    ...
    },
    {
      ...
      learnMoreHref: "/ar/models/bolden-s9-off-road",
      bookHref:      "/",
      className:     "slide-pure-design",
    },
    {
      ...
      align:   "center",
      overlay: "rgba(0,0,0,.42)",
      learnMoreHref: "/ar/models/bolden-s7-passenger",
      bookHref:      "/",
      className:     "slide-pure-design",
    },
    {
      ...
      align:   "right",
      overlay: "rgba(0,0,0,.42)",
      learnMoreHref: "/ar/models/bolden-s6-commercial",
      bookHref:      "/",
      className:     "slide-pure-design",
    },
  ],
