...
export default function InteriorGallerySwiper({ items = INTERIOR_GALLERY_ITEMS, title = "INTERIOR" }) {
  ...
  return (
    <section id="interior" className={styles.wrap} aria-labelledby="gallery-title">
