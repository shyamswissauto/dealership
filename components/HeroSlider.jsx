...
export default function HeroSlider({
  ...
  slides = [
    ...
    },
    {
      ...
      title:   "Sinotruck VGV: Strength Meets Style",
      subtitle:"Smart technology, spacious interiors, and sleek design—your everyday SUV, elevated.",
      align:   "left",
      overlay: "rgba(0,0,0,.28)",
      learnMoreHref: "/models/city-mountain",
      bookHref:      "/test-drive?model=city-mountain",
      className:     "slide-city-mountain",
    },
    {
      desktop: "/assets/hero/slide2-desktop.webp",
      mobile:  "/assets/hero/slide2-mobile.webp",
      title:   "Bolden Cars by Sinotruck",
      subtitle:"Discover Bolden’s diverse lineup - Perfect for work, family & Adventure",
      align:   "center",
      overlay: "rgba(0,0,0,.32)",
      learnMoreHref: "/models/pure-design",
      bookHref:      "/test-drive?model=pure-design",
